...
//    "status_msg.user.phone_bad" => "Nr. di telefono non valido",
    ...
    "status_msg.recover_password.no_account_with_login" => "Impossibile trovare l'account avente login \"{%login%}\"",
    "status_msg.recover_password.no_account_with_email" => "Impossibile trovare l'account avente indirizzo email \"{%email%}\"",
    ...
    "page_title.newsletter_categories" => "!!Category of newsletters",
    "page_title.newsletter_categories_category_edit_new" => "!!Add newsletter category",
    "page_title.newsletter_categories_category_edit" => "!!Edit category",
...
//    "status_msg.newsletter_category.name_empty" => "Specify newsletter category name",
    ...
    "status_msg.category1.deleted" => "Categoria1 cancellata",

    "status_msg.category1.name_empty" => "Inserire il nome della categoria1",

    "status_msg.category2.added" => "Categoria2 aggiunta",
    "status_msg.category2.updated" => "Categoria2 aggiornata",
    "status_msg.category2.deleted" => "Categoria2 cancellata",

    "status_msg.category2.name_empty" => "Inserire il nome della categoria2",

    "status_msg.category3.added" => "Categoria3 aggiunta",
    "status_msg.category3.updated" => "Categoria3 aggiornata",
    "status_msg.category3.deleted" => "Categoria3 cancellata",

    "status_msg.category3.name_empty" => "Inserire il nome della categoria3",
